...
function PlayerWalkWithPotState:update(dt)
    if love.keyboard.isDown('left') then
        ...
        self.entity:changeAnimation('walk-left-with-pot')
    elseif love.keyboard.isDown('right') then
        self.entity.direction = 'right'
        self.entity:changeAnimation('walk-right-with-pot')
    elseif love.keyboard.isDown('up') then
        self.entity.direction = 'up'
        self.entity:changeAnimation('walk-up-with-pot')
    elseif love.keyboard.isDown('down') then
        self.entity.direction = 'down'
        self.entity:changeAnimation('walk-down-with-pot')
    else
...
function PlayerWalkWithPotState:render()
